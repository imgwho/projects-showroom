...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden border-b border-neutral-200 bg-white pt-12 pb-16">
      {/* 背景微暗网格 */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-base sm:text-lg text-neutral-600 max-w-2xl leading-relaxed">
              深度融合大语言模型、Custom Agents、MCP 协议与自动化工作流。在 BI 报表、SaaS 模板、数据分析及自动化工具领域以极高效率孵化了 <strong className="text-neutral-900 font-bold">180+ 个实战项目案例</strong>。
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
              <div className="flex-1 flex items-center justify-between font-mono text-xs bg-neutral-50 border border-neutral-200 rounded-md px-3.5 py-2.5 text-neutral-800 shadow-inner">
                <div className="flex items-center space-x-2 truncate">
                  ...
                  <span className="text-neutral-900 font-bold">{commandSnippet}</span>
                </div>
                <button
                  onClick={handleCopy}
                  className="ml-3 p-1 text-neutral-500 hover:text-black transition-colors"
                  title="复制安装命令"
                >
            ...
            {/* 技术栈 */}
            <div className="flex flex-wrap items-center gap-2 pt-2 text-xs text-neutral-500 font-mono">
              <span className="text-neutral-700 font-bold">核心技术:</span>
              ...
              <span className="rounded border border-neutral-200 bg-neutral-100 px-2 py-0.5 text-neutral-800 font-medium">RAG 检索架构</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 grid grid-cols-2 gap-4">
            ...
            <div className="rounded-lg border border-neutral-200 bg-neutral-50/80 p-5 hover:border-neutral-400 transition-all shadow-xs">
              ...
              <div className="text-3xl font-extrabold font-mono text-neutral-900">{STATS.totalProjects}</div>
              <p className="mt-1 text-[11px] text-neutral-500">包含完整子项目与模块</p>
            </div>
            ...
            <div className="rounded-lg border border-neutral-200 bg-neutral-50/80 p-5 hover:border-neutral-400 transition-all shadow-xs">
              ...
              <div className="text-3xl font-extrabold font-mono text-sky-700">{STATS.imageProjects}</div>
              <p className="mt-1 text-[11px] text-neutral-500">配有高保真效果截图</p>
            </div>
            ...
            <div className="rounded-lg border border-neutral-200 bg-neutral-50/80 p-5 hover:border-neutral-400 transition-all shadow-xs">
              ...
              <div className="text-3xl font-extrabold font-mono text-neutral-900">{STATS.githubRepos}</div>
              <p className="mt-1 text-[11px] text-neutral-500">附带官方 GitHub 仓库</p>
            </div>
            ...
            <div className="rounded-lg border border-neutral-200 bg-neutral-50/80 p-5 hover:border-neutral-400 transition-all shadow-xs">
              ...
              <div className="text-3xl font-extrabold font-mono text-emerald-700">2</div>
              <p className="mt-1 text-[11px] text-neutral-500">cwprep & cwtwb</p>
            </div>
